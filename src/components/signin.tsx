...
//         <h2 className="text-2xl underline font-extrabold text-center mb-6 text-gray-800">Admin Sign In</h2>
//         <input
//           type="text"
//           placeholder="Enter your username"
//           value={username}
//           onChange={(e) => setUsername(e.target.value)}
//           className="p-2 w-full border border-gray-700 rounded-lg mb-2"
//         />
//         <input
//           type="password"
...
//         <button onClick={handleLogin} className="w-full mt-4 p-2 bg-gray-800 text-white rounded-lg">Sign In</button>
//       </div>
//     </div>
//   );
// }
